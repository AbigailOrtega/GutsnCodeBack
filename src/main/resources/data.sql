...
/*Entries for Post*/
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION, IMAGE) VALUES (1, 'JAVA POST 01',0,0,'java','3000-12-31',1,1,'3000-12-31', 1, 'JAVA POST 01', 'CDMX', FILE_READ('/opt/java.png'));
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION, IMAGE) VALUES (2, 'JAVA POST 02',0,0,'java','3000-12-31',1,1,'3000-12-31', 1, 'JAVA POST 02', 'CDMX', FILE_READ('/opt/java.png'));
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION, IMAGE) VALUES (3, 'JAVA POST 03',0,0,'java','3000-12-31',1,1,'3000-12-31', 1, 'JAVA POST 03', 'CDMX', FILE_READ('/opt/java.png'));
/**/
