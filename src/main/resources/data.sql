...
/*Entries for Post*/
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES (1, 'JAPA POST 01',0,0,'java','2009-01-01',1,1,'2019-01-02', 1, 'POST 10', 'CDMX');
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES (2, 'JAPA POST 02',0,0,'java','2019-02-01',1,1,'2019-02-02', 1, 'POST 11', 'CDMX');
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES (3, 'JAPA POST 03',0,0,'java','2011-03-01',1,1,'2019-03-02', 1, 'POST 12', 'CDMX');
/**/
