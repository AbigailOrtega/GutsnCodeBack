...
, (4, 'PARA APROVAR',0,2,'java','3000-01-01',1,1,'3000-12-31', 1, 'PARA APROVAR', 'CDMX', null)
;
/**/
...
, ('POST25',0,0,'java'  ,'2019-11-25',1,1,'2019-11-25', 1, 'POST 25', 'CDMX',null)
...
, ('POST31',0,2,'java'  ,'2019-12-01',1,1,'2019-12-01', 1, 'POST 31', 'CDMX',null)
, ('POST32',0,2,'java'  ,'2019-12-02',1,1,'2019-12-02', 1, 'POST 32', 'CDMX',null)
, ('POST33',0,2,'java'  ,'2019-12-03',1,1,'2019-12-03', 1, 'POST 33', 'CDMX',null)
, ('POST34',0,2,'java'  ,'2019-12-04',1,1,'2019-12-04', 1, 'POST 34', 'CDMX',null)
, ('POST35',0,2,'java'  ,'2019-12-05',1,1,'2019-12-05', 1, 'POST 35', 'CDMX',null)
, ('POST36',0,2,'devops','2019-12-06',1,1,'2019-12-06', 1, 'POST 36', 'CDMX',null)
, ('POST37',0,2,'devops','2019-12-07',1,1,'2019-12-07', 1, 'POST 37', 'CDMX',null)
, ('POST38',0,2,'devops','2019-12-08',1,1,'2019-12-08', 1, 'POST 38', 'CDMX',null)
, ('POST39',0,2,'devops','2019-12-09',1,1,'2019-12-09', 1, 'POST 39', 'CDMX',null)
, ('POST40',0,2,'devops','2019-12-10',1,1,'2019-12-10', 1, 'POST 40', 'CDMX',null)
;
/*Entries for News*/
insert into POST (POST_ID, NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION, IMAGE) VALUES
...
, (48,'PARA APROVAR',0,2,'spring','3000-01-01',1,1,'3000-01-01', 0, 'PARA APROVAR', 'CDMX',null)
;
/**/
...
/**/
insert into POST (NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION, IMAGE) VALUES
  ('NEWS01',0,0,'kotlin' ,'2019-11-01',1,1,'2019-11-01', 0, 'NEWS 01', 'CDMX',null)
, ('NEWS02',0,0,'kotlin' ,'2019-11-02',1,1,'2019-11-02', 0, 'NEWS 02', 'CDMX',null)
, ('NEWS03',0,0,'kotlin' ,'2019-11-03',1,1,'2019-11-03', 0, 'NEWS 03', 'CDMX',null)
, ('NEWS04',0,0,'kotlin' ,'2019-11-04',1,1,'2019-11-04', 0, 'NEWS 04', 'CDMX',null)
, ('NEWS05',0,0,'kotlin' ,'2019-11-05',1,1,'2019-11-05', 0, 'NEWS 05', 'CDMX',null)
, ('NEWS06',0,2,'kotlin' ,'2019-11-06',1,1,'2019-11-06', 0, 'NEWS 06', 'CDMX',null)
, ('NEWS07',0,2,'kotlin' ,'2019-11-07',1,1,'2019-11-07', 0, 'NEWS 07', 'CDMX',null)
, ('NEWS08',0,2,'kotlin' ,'2019-11-08',1,1,'2019-11-08', 0, 'NEWS 08', 'CDMX',null)
, ('NEWS09',0,2,'kotlin' ,'2019-11-09',1,1,'2019-11-09', 0, 'NEWS 09', 'CDMX',null)
, ('NEWS10',0,2,'kotlin' ,'2019-11-10',1,1,'2019-11-10', 0, 'NEWS 10', 'CDMX',null)
, ('NEWS11',0,0,'graalvm','2019-11-11',1,1,'2019-11-11', 0, 'NEWS 11', 'CDMX',null)
, ('NEWS12',0,0,'graalvm','2019-11-12',1,1,'2019-11-12', 0, 'NEWS 12', 'CDMX',null)
, ('NEWS13',0,0,'graalvm','2019-11-13',1,1,'2019-11-13', 0, 'NEWS 13', 'CDMX',null)
, ('NEWS14',0,0,'graalvm','2019-11-14',1,1,'2019-11-14', 0, 'NEWS 14', 'CDMX',null)
, ('NEWS15',0,0,'graalvm','2019-11-15',1,1,'2019-11-15', 0, 'NEWS 15', 'CDMX',null)
, ('NEWS16',0,2,'graalvm','2019-11-16',1,1,'2019-11-16', 0, 'NEWS 16', 'CDMX',null)
, ('NEWS17',0,2,'graalvm','2019-11-17',1,1,'2019-11-17', 0, 'NEWS 17', 'CDMX',null)
, ('NEWS18',0,2,'graalvm','2019-11-18',1,1,'2019-11-18', 0, 'NEWS 18', 'CDMX',null)
, ('NEWS19',0,2,'graalvm','2019-11-19',1,1,'2019-11-19', 0, 'NEWS 19', 'CDMX',null)
, ('NEWS20',0,2,'graalvm','2019-11-20',1,1,'2019-11-20', 0, 'NEWS 20', 'CDMX',null)
, ('NEWS21',0,0,'apache' ,'2019-11-21',1,1,'2019-11-21', 0, 'NEWS 21', 'CDMX',null)
, ('NEWS22',0,0,'apache' ,'2019-11-22',1,1,'2019-11-22', 0, 'NEWS 22', 'CDMX',null)
, ('NEWS23',0,0,'apache' ,'2019-11-23',1,1,'2019-11-23', 0, 'NEWS 23', 'CDMX',null)
, ('NEWS24',0,0,'apache' ,'2019-11-24',1,1,'2019-11-24', 0, 'NEWS 24', 'CDMX',null)
, ('NEWS25',0,0,'apache' ,'2019-11-25',1,1,'2019-11-25', 0, 'NEWS 25', 'CDMX',null)
, ('NEWS26',0,2,'apache' ,'2019-11-26',1,1,'2019-11-26', 0, 'NEWS 26', 'CDMX',null)
, ('NEWS27',0,2,'apache' ,'2019-11-27',1,1,'2019-11-27', 0, 'NEWS 27', 'CDMX',null)
, ('NEWS28',0,2,'apache' ,'2019-11-28',1,1,'2019-11-28', 0, 'NEWS 28', 'CDMX',null)
, ('NEWS29',0,2,'apache' ,'2019-11-29',1,1,'2019-11-29', 0, 'NEWS 29', 'CDMX',null)
, ('NEWS30',0,2,'apache' ,'2019-11-30',1,1,'2019-11-30', 0, 'NEWS 30', 'CDMX',null)
, ('NEWS31',0,0,'java'   ,'2019-12-01',1,1,'2019-12-01', 0, 'NEWS 31', 'CDMX',null)
, ('NEWS32',0,0,'java'   ,'2019-12-02',1,1,'2019-12-02', 0, 'NEWS 32', 'CDMX',null)
, ('NEWS33',0,0,'java'   ,'2019-12-03',1,1,'2019-12-03', 0, 'NEWS 33', 'CDMX',null)
, ('NEWS34',0,0,'java'   ,'2019-12-04',1,1,'2019-12-04', 0, 'NEWS 34', 'CDMX',null)
, ('NEWS35',0,0,'java'   ,'2019-12-05',1,1,'2019-12-05', 0, 'NEWS 35', 'CDMX',null)
, ('NEWS36',0,0,'spring' ,'2019-12-06',1,1,'2019-12-06', 0, 'NEWS 36', 'CDMX',null)
, ('NEWS37',0,0,'spring' ,'2019-12-07',1,1,'2019-12-07', 0, 'NEWS 37', 'CDMX',null)
, ('NEWS38',0,0,'spring' ,'2019-12-08',1,1,'2019-12-08', 0, 'NEWS 38', 'CDMX',null)
, ('NEWS39',0,0,'spring' ,'2019-12-09',1,1,'2019-12-09', 0, 'NEWS 39', 'CDMX',null)
, ('NEWS40',0,0,'spring' ,'2019-12-10',1,1,'2019-12-10', 0, 'NEWS 40', 'CDMX',null)
;
/*Text for Post*/
