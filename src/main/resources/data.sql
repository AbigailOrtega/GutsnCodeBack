...
/*Entries for News*/
insert into POST (NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES ('NEWS0',0,0,'java','2009-01-01',1,1,'2019-01-02', 0, 'NEWS 0', 'CDMX');
insert into POST (NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES ('NEWS1',0,0,'spring','2019-02-01',1,1,'2019-02-02', 0, 'NEWS 1', 'CDMX');
insert into POST (NAME, NUMBER_VIEW, STATUS_ID, TOPIC, LAST_UPDATE, WRITTER_ID, REVIEWER_ID, DATE_REVIEWER, TYPE_POST_ID, TITLE, LOCATION) VALUES ('NEWS2',0,0,'kotlin','2011-03-01',1,1,'2019-03-02', 0, 'NEWS 2', 'CDMX');
...
/*Text for News*/
insert into TEXT (TEXT_ID,TYPE_TEXT_ID,POST_ID,TEXT_BETA,TEXT_REALIZE) VALUES (4,1,45,'','Hola, somos Aby y Sebas y somos los fundadores de Guts & Code, y creamos esta pagina para regañar a Sebas por flojo');
insert into TEXT (TEXT_ID,TYPE_TEXT_ID,POST_ID,TEXT_BETA,TEXT_REALIZE) VALUES (5,0,45,'','¿Quienes somos?');
insert into TEXT (TEXT_ID,TYPE_TEXT_ID,POST_ID,TEXT_BETA,TEXT_REALIZE) VALUES (6,2,45,'','Nos despendimos, y recuerden, Sebas es un flojo');
